...
//#define UDP_DESCRIPTOR_CONF_SIZE		0xf8  d0
<<<<<<< HEAD
#define UDP_DESCRIPTOR_CONF_SIZE		0xd9
=======
#define UDP_DESCRIPTOR_CONF_SIZE		0xe2
...
#define UDP_AC_TERM_IN_MIC_ID				1
#define UDP_AC_TERM_IN_USB_ID				2
#define UDP_AC_TERM_OUT_USB_ID				3
#define UDP_AC_TERM_OUT_PHONE_ID			4
